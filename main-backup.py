...
def circles_intersections(circles: list[Circle]):
	for i in range(len(circles)):
		for j in range(i+1, len(circles)):
			...
			# if x1<=middle_point_x<=x2 or x2<=middle_point_x<=x1:
			# 	box_mid_size1 = r1 - distance_between_points(middle_point_x, middle_point_y, x1, y1)
			# 	box_mid_size2 = r2 - distance_between_points(middle_point_x, middle_point_y, x2, y2)
			# else:
			# 	box_mid_size1 = r1 + distance_between_points(middle_point_x, middle_point_y, x1, y1)
			# 	box_mid_size2 = r2 - distance_between_points(middle_point_x, middle_point_y, x2, y2)
			...
			# 	if x1<x2:
			# 		ul = intersection_x1-box_mid_size2
			# 		ur = intersection_x1+box_mid_size1
			# 		dl = intersection_x2-box_mid_size2
			# 		dr = intersection_x2+box_mid_size1
			# 		pygame.draw.circle(surface, "white", (ul, intersection_y1), 5)
			# 		pygame.draw.circle(surface, "white", (ur, intersection_y1), 5)
			# 		pygame.draw.circle(surface, "white", (dl, intersection_y2), 5)
			# 		pygame.draw.circle(surface, "white", (dr, intersection_y2), 5)
			# 	else:
			# 		ul = intersection_x2-box_mid_size1
			# 		ur = intersection_x2+box_mid_size2
			# 		dl = intersection_x1-box_mid_size1
			# 		dr = intersection_x1+box_mid_size2
			# 		pygame.draw.circle(surface, "white", (ul, intersection_y2), 5)
			# 		pygame.draw.circle(surface, "white", (ur, intersection_y2), 5)
			# 		pygame.draw.circle(surface, "white", (dl, intersection_y1), 5)
			# 		pygame.draw.circle(surface, "white", (dr, intersection_y1), 5)
